...
# Палитра для приближённого отображения цвета катушки эмодзи (круги + цветные
# сердечки из Unicode 15 - 🩶🩷🩵 добавлены именно для доп. оттенков, не для
# эстетики). Это потолок обычных Unicode-эмодзи: настоящих "цветовых чипов"
# в стандарте больше не существует, кастомные emoji сюда не подходят - видны
# только у Telegram Premium.
_COLOR_EMOJI = [
    ((255, 255, 255), "⚪"),
    ((0, 0, 0), "⚫"),
    ((142, 142, 147), "🩶"),
